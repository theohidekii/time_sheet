...
- **Visual Indicators:**
  ...
  - 🔴 Red text for negative balance/lateness.
  - ⚠️ Alerts for inconsistencies (odd number of punches, missing lunch break).
...
5. **Export:** Click "Exportar Relatório" to download the Excel spreadsheet.
